    ...
    return (
        ...
        >
            <div className="flex-1 overflow-y-auto -mx-1 px-1 text-[12px] leading-relaxed text-slate-300 space-y-3">
                ...
                {/* A colophon, not a credit. The entries above record whose work this rests on;
                    this line records where the work continues. Kept dim and last so it reads as a
                    footer, and neutral — it states no machine state, so it borrows no accent. One
                    hairline, the same one the build line uses; a second device on the same edge
