    ...
    return (
        <>
            ...
            <div
                ...
                className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[560px] max-h-[80vh] flex flex-col bg-slate-900 border border-slate-700 rounded-lg shadow-xl z-50 p-4 animate-in fade-in zoom-in-95 duration-200"
            >
                ...
                <div className="flex-1 overflow-y-auto -mx-1 px-1 text-[11px] leading-relaxed text-slate-300 space-y-3">
                    <p>{t.intro}</p>
                    ...
                    <p className="text-[10px] text-slate-500">{t.agreeNote}</p>
                </div>

                <div className="shrink-0 pt-3 mt-3 border-t border-slate-800 flex items-center justify-between gap-4">
                    <label className="flex items-center gap-2 cursor-pointer text-[10px] text-slate-400 uppercase tracking-wider select-none">
                        <input
                            type="checkbox"
                    ...
                    <button
                        ...
                        className="bg-blue-600 hover:bg-blue-500 text-white text-[10px] font-bold uppercase tracking-widest px-4 py-2 rounded flex items-center gap-1.5 transition-colors"
                    >
