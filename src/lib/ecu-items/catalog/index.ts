...
import { DENSITY_ITEMS } from './density';
 ...
 */
export const ECU_ITEMS: EcuItemDef[] = [
    ...EGT_ITEMS, ...DENSITY_ITEMS, ...FUEL_ITEMS, ...IDLE_ITEMS, ...INERTIA_ITEMS,
];
...
export { DENSITY_ITEMS, EGT_ITEMS, FUEL_ITEMS, IDLE_ITEMS, INERTIA_ITEMS };
